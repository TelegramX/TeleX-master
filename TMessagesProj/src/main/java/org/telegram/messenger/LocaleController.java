...
import sections.shamsi.ShamsiCalendar;
import sections.shamsi.ShamsiDate;
...
public class LocaleController {
    ...
    public LocaleController() {
        ...
        addRules(new String[]{"fa"}, new PluralRules_Arabic());
...
//    }
    ...
    public void recreateFormatters() {
        ...
        isRTL = lang.startsWith("ar") || lang.startsWith("fa")|| BuildVars.DEBUG_VERSION && (lang.startsWith("he") || lang.startsWith("iw") );
