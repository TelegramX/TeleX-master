...
public class ThemCellPro extends FrameLayout {
    ...
    public ThemCellPro(Context context) {
        super(context);
        ...
        addView(textView, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.MATCH_PARENT, Gravity.CENTER | Gravity.TOP,0, 0,0, 0));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int x = AndroidUtilities.dp(16 + 55);
        if (LocaleController.isRTL) {
            x = getWidth() - x;
        }
        canvas.drawCircle(x, AndroidUtilities.dp(13 + 55), AndroidUtilities.dp(55), paint);
    }
}
